...
func (c *userManagerClient) GetUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserManagerServer) GetUser(context.Context, *UserRequest) (*UserResponse, error) {
